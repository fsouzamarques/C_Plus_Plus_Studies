...
int main() {
  //Declaring the variable to store the dog's age
  int dog_age;
  ...
  //Early Years equals 21 human years
  early_years = 21;

  //Enter the Dog Age
  cout << "What's your Dog's Name? " << endl;
  cin >> dog_name;

  cout << "What's your Dog's Age? (Only works for 2+yo) " << endl;
  cin >> dog_age;

  //Later Years subtracts the first two years and multiply by 4 each year remaining
  later_years = (dog_age - 2)*4;

  human_years = early_years + later_years;

  cout << "My name is " << dog_name << "! Ruff ruff, I am " << human_years << " years old in human years!" << endl;
